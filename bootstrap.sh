...
# `eosio` account is already precreated on fresh node, it's pubkey is EOS55oVd4ZyC2QMiAMzs1WFYzEYU1GKAAALPCa45Dzs9wrUWo3hjD (defined in genesis block)
# the priv key is: 5JqSHvebnpcDKmhmTiWfdsbkZKDmDsB95FUu1bZR49DvMBKoWP8
...
cleos wallet import --private-key 5JqSHvebnpcDKmhmTiWfdsbkZKDmDsB95FUu1bZR49DvMBKoWP8
...
do
  cleos create account eosio ${x} EOS55oVd4ZyC2QMiAMzs1WFYzEYU1GKAAALPCa45Dzs9wrUWo3hjD
done
...
retry cleos system newaccount eosio --transfer testaccount1 EOS55oVd4ZyC2QMiAMzs1WFYzEYU1GKAAALPCa45Dzs9wrUWo3hjD --stake-net "9000000000.0000 EOS" --stake-cpu "9000000000.0000 EOS" --buy-ram-kbytes 8192
retry cleos transfer eosio testaccount1 "50000000000.0000 EOS"

# register and vote for producer to make chain activated
# otherwise we can't undelegate resources
retry cleos system regproducer eosio EOS55oVd4ZyC2QMiAMzs1WFYzEYU1GKAAALPCa45Dzs9wrUWo3hjD
retry cleos system voteproducer prods testaccount1 eosio
